# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-06-26 09:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_type', models.CharField(choices=[('server', '服务器'), ('networkdevice', '网络设备'), ('storagedevice', '存储设备'), ('securitydevice', '安全设备'), ('accessories', '备件'), ('software', '软件资产')], default='server', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_count', models.SmallIntegerField(default=1, verbose_name='物理cpu个数')),
                ('cpu_core_count', models.SmallIntegerField(default=1, verbose_name='cpu核数')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
                ('create_date', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', models.TextField(blank=True, null=True, verbose_name='事件详情')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manufactory', models.CharField(max_length=64, unique=True, verbose_name='制造商名称')),
                ('suppport_num', models.CharField(blank=True, max_length=32, null=True, verbose_name='支持电话')),
                ('memo', models.CharField(blank=True, max_length=128, null=True, verbose_name='备注')),
            ],
            options={
                'verbose_name': '制造商表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_num', models.IntegerField(default=1, verbose_name='授权数')),
